Public Class frmSolicitacoesAlteracao
    ...
    Private Sub BindGrid()
        ...
        oDataTable = objSolicitacaoAlteracao.getSolicitacaoAlteracao_ByFiltro(oSchDadosFiltro)
    ...
    Private Sub grdSolicitacoes_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdSolicitacoes.RowCommand
        If e.CommandName = "Detalhar" Then
            ...
            Dim oSolicitacaoAlteracao As New BLL.bllSolicitacaoAlteracao
            Dim objSchSolicitacaoAlteracao As ShL.schSolicitacaoAlteracao
            objSchSolicitacaoAlteracao = oSolicitacaoAlteracao.getSolicitacaoAlteracaoByPK(iID)

            Session("objSolicitacaoAlteracao") = objSchSolicitacaoAlteracao
            Response.Redirect("frmDetalheSolicitacaoAlteracao.aspx")

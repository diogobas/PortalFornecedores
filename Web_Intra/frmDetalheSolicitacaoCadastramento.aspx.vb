Public Class frmDetalheSolicitacaoCadastramento
    ...
    Private Sub CarregaTela(objSolicitacao As ShL.schSolicitacaoCadastro)
        ...
        txtComoConheceu.Text = objSolicitacao.objDadosAdicionais.objComoConheceu.dc_como_conheceu
        txtContato.Text = objSolicitacao.objDadosAdicionais.no_contato
    ...
    Protected Sub btValidar_Click(sender As Object, e As EventArgs) Handles btValidar.Click
        ExibeMensagemPopUp("Confirmação", "Confirma validação da solicitação de cadastro?", "Confirma")
    End Sub

<%@ Page Title="Gestão de Fornecedores Duratex" Language="vb" AutoEventWireup="false"
    MasterPageFile="~/Page.Master" CodeBehind="frmSolicitacoesAlteracao.aspx.vb"
    Inherits="PortalFornecedores_Intra.frmSolicitacoesAlteracao" %>
                                ...
                                <tr height="280">
                                    <td valign="top" style="padding-top: 10px">
                                        <asp:GridView ID="grdSolicitacoes" runat="server" AllowPaging="True" class="grid"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="id_solicitacao_alteracao" 
                                                    HeaderText="id_solicitacao_alteracao">

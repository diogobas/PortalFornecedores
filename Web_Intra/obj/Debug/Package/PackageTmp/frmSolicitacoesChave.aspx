<%@ Page Title="Gestão de Fornecedores Duratex" Language="vb" AutoEventWireup="false"
    MasterPageFile="~/Page.Master" CodeBehind="frmSolicitacoesChave.aspx.vb" Inherits="PortalFornecedores_Intra.frmSolicitacoesChave" %>
                                ...
                                <tr height="280">
                                    <td valign="top" style="padding-top: 10px">
                                        <asp:GridView ID="grdSolicitacoes" runat="server" AllowPaging="True" class="grid"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="id_solicitacao_chave_acesso" 
                                                    HeaderText="id_solicitacao_chave_acesso">
                                                <ControlStyle CssClass="hiddencol" />
                                                <FooterStyle CssClass="hiddencol" />
                                                <HeaderStyle CssClass="hiddencol" />
                                                <ItemStyle CssClass="hiddencol" Width="50px" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="nm_cnpj" HeaderText="CNPJ" >
                                                <ControlStyle CssClass="hiddencol" />
                                                <FooterStyle CssClass="hiddencol" />
                                                <HeaderStyle CssClass="hiddencol" />
                                                ...
                                                <asp:ButtonField 
                                                    CommandName="Detalhar" DataTextField="nm_cnpj_nm" 
                                                    DataTextFormatString="{0:00\.000\.000\/0000\-00}" HeaderText="CNPJ">
                                                ...
                                                <asp:BoundField HeaderText="Email" DataField="xx_email" 
                                                ...
                                                <asp:ButtonField ButtonType="Image" CommandName="Detalhar" 
                                                    DataTextField="nm_cnpj_nm" DataTextFormatString="{0:00\.000\.000\/0000\-00}" 

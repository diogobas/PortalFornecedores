                                ...
                                <ContentTemplate>
                                    <table width="850px">
                                        <tr>
                                            ...
                                            <td align="right">
                                                <asp:Button class="bt_outros" ID="btRecusar" runat="server" Text="Recusar" />
                                            </td>                                            
                                        </tr>
                                        <tr>
                                            <td colspan=5>
                                                <asp:TextBox class="txt_form" ID="txtMotivoRecusa" runat="server" 
                                                TextMode="MultiLine" Height="121px" Width="687px" Visible=false 
                                                    style="margin-top:10px;"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                                <asp:Button class="bt_outros" ID="btMotivo" runat="server" Text="Motivo" Visible=false/>
                                                <br><br>
                                                <asp:Button class="bt_outros" ID="btCancelar" runat="server" Text="Cancelar" Visible=false /> 
                                                <br><br>
                                                <asp:Button class="bt_outros" ID="btVoltar2" runat="server" Text="Voltar" Visible=false />                                                
                                            </td>                                                
                                        </tr>
                                    </table>
                                </ContentTemplate>
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btVoltar"/>
                                    <asp:PostBackTrigger ControlID="btValidar"/>
                                    <asp:PostBackTrigger ControlID="btMotivo"/>
                                    <asp:AsyncPostBackTrigger ControlID="btRecusar" EventName="Click"/>                                    
                                </Triggers>
                            </asp:UpdatePanel>
                        </td>
                    </tr>

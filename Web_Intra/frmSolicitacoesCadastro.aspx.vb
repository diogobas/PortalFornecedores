Public Class frmSolicitacoesCadastro
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Not Session("oSchDadosFiltro") Is Nothing Then
                ...
                ddlOperacao.SelectedValue = oSchDadosFiltro.cd_operacao
                ddlOrigem.SelectedValue = IIf(oSchDadosFiltro.cd_origem = "", "I", oSchDadosFiltro.cd_origem)
            End If
    ...
    Private Sub grdSolicitacoes_DataBinding(sender As Object, e As System.EventArgs) Handles grdSolicitacoes.DataBinding
        'For Each linha As GridViewRow In sender.Rows
        '    linha.Cells(0).
        'Next()
    End Sub
    ...
    Private Sub BindGrid()
        Dim objSolicitacaoCadastro As New BLL.bllSolicitacaoCadastro
        Dim oDataTable As Data.DataTable
        Dim oSchDadosFiltro As New ShL.schDadosFiltro

        oSchDadosFiltro = GetFiltro()

        oDataTable = objSolicitacaoCadastro.getSolicitacaoCadastro_ByFiltro(oSchDadosFiltro)
    ...
    Private Function GetFiltro() As ShL.schDadosFiltro
        ...
        oSchDadosFiltro.cd_origem = ddlOrigem.SelectedValue
        oSchDadosFiltro.cd_operacao = ddlOperacao.SelectedValue
    ...
    Private Sub grdSolicitacoes_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdSolicitacoes.RowCommand
        If e.CommandName = "Detalhar" Then
            Dim iIdentificacao As Integer = 0
            iIdentificacao = grdSolicitacoes.Rows(Convert.ToInt16(e.CommandArgument)).Cells(8).Text


            Dim oSolicitacaoCadastro As New BLL.bllSolicitacaoCadastro
            Dim objSchSolicitacao As ShL.schSolicitacaoCadastro
            objSchSolicitacao = oSolicitacaoCadastro.getSolicitacaoCadastroByID(iIdentificacao)

            Session("objSolicitacao") = objSchSolicitacao
            If objSchSolicitacao.objDadosBasicos.no_tipo_solicitacao = "I" Then
                Response.Redirect("frmDetalheSolicitacaoCadastramento_Intra.aspx")
            Else
                Response.Redirect("frmDetalheSolicitacaoCadastramento.aspx")
            End If
        End If
    End Sub
    ...
    Private Sub ddlOperacao_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlOperacao.SelectedIndexChanged
        btBusca_Click(sender, e)
    End Sub

    Private Sub ddlOrigem_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlOrigem.SelectedIndexChanged
        btBusca_Click(sender, e)
    End Sub
End Class
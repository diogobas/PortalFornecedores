Public Class _Default1
    ...
    Protected Sub btEnviarCadastramento_Click(sender As Object, e As EventArgs) Handles btEnviarCadastramento.Click
        If Not ValidaCamposCadastramento() Then
            Exit Sub
        End If

        Session("CNPJ") = txtCNPJCadastramento.Text
    ...
    Private Function ValidaCamposCadastramento() As Boolean
        ValidaCamposCadastramento = False
        Dim oValidacao As New Common.Validacao
        If txtCNPJCadastramento.Text.Length = 0 Then
            ExibeMensagemPopUp("Dados Incorretos", "Informe o CNPJ.")
            txtCNPJCadastramento.Focus()
            Exit Function
        End If
        Try
            oValidacao.cnpj = txtCNPJCadastramento.Text
            txtCNPJCadastramento.Focus()
        Catch ex As Exception
            ExibeMensagemPopUp("Dados Incorretos", "CNPJ Inválido.")
            txtCNPJCadastramento.Text = ""
            Exit Function
        End Try
        Return True
    End Function
        ...
        Try
            ...
            If Not oDataTable Is Nothing Then
                If oDataTable.Rows(0).Item("cd_status_chave_acesso") = 0 Then
                    ...
                    'oSolicitacaoCadastro.EnviaEmailAnalise(objSchSolicitacao)
                    'oSolicitacaoCadastro.EnviaEmailRetorno(objSchSolicitacao)

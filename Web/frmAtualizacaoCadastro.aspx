<%@ Page Title="Portal Fornecedores Duratex / Atualização de Cadastro" Language="vb" AutoEventWireup="false"
    MasterPageFile="~/Page.Master" CodeBehind="frmAtualizacaoCadastro.aspx.vb" Inherits="PortalFornecedores.frmAtualizacaoCadastro" %>
        ...
        <div class="align_content" sizcache="3" sizset="0">
            ...
            <div class="content_center">
                <table width="910px">
                    ...
                    <tr>
                        <td width="100%" align="center" class="box_atualiza_endereco" colspan="4">
                            <table width="850px">
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="3" align="left" width="474px">
                                        <asp:TextBox class="txt_form" ID="txtEndereco" runat="server" Width="435px" 
                                    ...
                                    <td width="88px" align="left" colspan="2">
                                        <asp:TextBox class="txt_form" ID="txtComplemento" runat="server" Width="71px" 
                                            MaxLength="10"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left" width="326px">
                                        <asp:TextBox class="txt_form" ID="txtBairro" runat="server" Width="285px" 
                                    ...
                                    <td colspan="2" align="left" width="126px">
                                        <p class="label_form" align="left">
                                            Caixa Postal:</p>
                                    </td>
                                    <td colspan="3" align="left" width="149px">
                                        <asp:TextBox class="txt_form" ID="txtCaixaPostal" runat="server" Width="133px" 
                                            MaxLength="10"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox class="txt_form" ID="txtCidade" runat="server" Width="285px" 
                                            MaxLength="40"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <p class="label_form" align="left">
                    ...
                    <tr>
                        <td width="100%" align="center" class="box_dados_contato_empresa" colspan="4">
                            <table width="850px">
                                <tr>
                                    <td width="100px">
                                        <p class="label_form" align="left">
                                    ...
                                    <td width="315px" align="left">
                                        <asp:TextBox class="txt_form" ID="txtNomeContato" runat="server" Width="304px" 
                                    ...
                                    <td align="left">
                                        <asp:TextBox class="txt_form" ID="txtSobrenomeContato" runat="server" 
                                            Width="304px" MaxLength="35"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100px">
                                    ...
                                    <td width="315px" align="left">
                                        <asp:TextBox class="txt_form" ID="txtFuncaoContato" runat="server" 
                                            Width="304px" MaxLength="50"></asp:TextBox>
                                    </td>
                                    <td>
                                        <p class="label_form" align="left">
                                            Departamento:</p>
                                    ...
                                    <td align="left">
                                        <asp:TextBox class="txt_form" ID="txtDepartamentoContato" runat="server" 
                                            Width="304px" MaxLength="50"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox class="txt_form" ID="txtTelefoneContato" runat="server" onkeyup="javascript:formataTelefone(this,event);"
                                    ...
                                    <td align="left">
                                        <asp:TextBox class="txt_form" ID="txtFaxContato" runat="server" Width="150px" onkeyup="javascript:formataTelefone(this,event);"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox class="txt_form" ID="txtCelularContato" runat="server" Width="150px"
                                            MaxLength="30" onkeyup="javascript:mascara(this, formataTel9digitos);"></asp:TextBox>
                                    </td>
                                    <td>
                                        <p class="label_form" align="left">
                                            Email:</p>
                                    ...
                                    <td align="left">
                                        <asp:TextBox class="txt_form" ID="txtEmailContato" runat="server" Width="304px" 
                                            MaxLength="210"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>

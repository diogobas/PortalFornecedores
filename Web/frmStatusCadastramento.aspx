<%@ Page Title="Portal Fornecedores Duratex / Status Cadastramento" Language="vb"
    AutoEventWireup="false" MasterPageFile="~/Page.Master" CodeBehind="frmStatusCadastramento.aspx.vb"
    Inherits="PortalFornecedores.frmStatusCadastramento" %>
                      ...
                      <table width="910px">
                          <tr class="box_titulo_internas">
                              <td colspan="5">
                                  <p class="titulo_internas">
                                      Acompanhamento da Solicitação de Cadastramento
                                  </p>
                              </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                                <td width="100%" align="center" class="box_dados_empresa" colspan="5">
                                    ...
                                    <tr>
                                        <td width="100px">
                                        <p class="label_form" align="left">Razão Social:</p>
                                        </td>
                                        <td colspan=9 align="left">
                                            <asp:TextBox class="txt_form_label" ID="txtRazaoSocial" runat="server" Width="725px"></asp:TextBox>
                                        </td>
                                    </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <asp:TextBox class="txt_form_label" ID="txtCNPJ" runat="server" Width="145px">00.232.232/0001-00</asp:TextBox>
                                            </td>
                                            ...
                                            <asp:TextBox class="txt_form_label" ID="txtInscEstadual" runat="server" Width="137px"></asp:TextBox>
                                            </td>
                                            ...
                                            <td align="left" width="150px" colspan="3">
                                                <asp:TextBox class="txt_form_label" ID="txtInscMunicipal" runat="server" Width="133px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                ...
                                <table width="850px">
                                    <tr>
                                        ...
                                        <td align="left" colspan="2">
                                            <asp:TextBox class="txt_form_label" ID="txtSobrenomeContato" runat="server" 
